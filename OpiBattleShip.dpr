...
procedure check_coord(var coorrdin: coord; var field_with_boats,field,help_field_1: TMATRIX;  var s: string; var change:boolean);
var
  i, count: integer;
...
procedure show_war(var field, field_with_boats, other_field_with_boats,help_field_1,help_field_2: TMATRIX; var onemoreshot: boolean; var index1, index2: integer);
